 ...
 *
 */
public class ButtonColumnUpdate extends AbstractCellEditor
     ...
     */
    public ButtonColumnUpdate(JTable table, Action action, int column) {
        this.table = table;
        this.action = action;
...
//
    ...
    public Component getTableCellRendererComponent(
        ...
        if (isSelected) {
            ...
            if (row % 2 == 0) {
                renderButton.setBackground(new Color(255,251,228));
            }else {
                renderButton.setBackground(new Color(250,240,177));
            }
        }
