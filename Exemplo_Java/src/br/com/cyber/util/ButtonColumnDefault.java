...
import br.daniel.componente.KToolTip;
 ...
 *
 */
public class ButtonColumnDefault extends AbstractCellEditor
    ...
    public static KButton renderButton = new KButton();
     ...
     */
    public ButtonColumnDefault(JTable table, Action action, int column) {
        this.table = table;
        this.action = action;
...
//
    ...
    public Component getTableCellRendererComponent(
        ...
        KToolTip.createKToolTip(value.toString(), ButtonColumnDefault.renderButton);
